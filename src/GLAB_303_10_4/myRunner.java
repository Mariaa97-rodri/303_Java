...
public class myRunner {
    public static void main(String[] args) {
        ...
        rect.displayshapName();
        System.out.println("Area: " + rect.getArea());
        rect.moveRight();
        rect.moveUp();
        System.out.println("New Coordinates: " + rect.getCoordinate());

        System.out.println("--------Test Triangle-------");
        Triangle tri = new Triangle(10, 10, 4, 6);
        tri.displayshapName();
        System.out.println("Area: " + tri.getArea());
        tri.moveDown();
        tri.moveLeft();
        System.out.println("New Coordinates: " + tri.getCoordinate());
